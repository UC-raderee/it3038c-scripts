...
print('Options are as follows: Happy, Love, Silly, Flirty, Sad, Sick, Fancy, Dead')
...
if myMood == Happy:
    ...
    print('Putting on the ritz, baby! Put on your best and keep that feeling rol
ling. You are feeling:')
